!function (d, p, f, c) {
    ...
    function e() {
        this.isMobile = function () {
            ...
            var t = f.createElement("fakeelement"), o = {
    ...
    m.prototype = {
        reset: function () {
            ...
            var o = this.m[0] * t.m[0] + this.m[2] * t.m[1], i = this.m[1] * t.m[0] + this.m[3] * t.m[1],
                e = this.m[0] * t.m[2] + this.m[2] * t.m[3], s = this.m[1] * t.m[2] + this.m[3] * t.m[3],
            ...
            var t = new m;
            t.m = this.m.slice(0);
            var o = 1 / (t.m[0] * t.m[3] - t.m[1] * t.m[2]), i = t.m[3] * o, e = -t.m[1] * o, s = -t.m[2] * o,
                a = t.m[0] * o, n = o * (t.m[2] * t.m[5] - t.m[3] * t.m[4]),
                h = o * (t.m[1] * t.m[4] - t.m[0] * t.m[5]);
            return t.m[0] = i, t.m[1] = e, t.m[2] = s, t.m[3] = a, t.m[4] = n, t.m[5] = h, t
        }, rotate: function (t) {
            var o = Math.cos(t), i = Math.sin(t), e = this.m[0] * o + this.m[2] * i, s = this.m[1] * o + this.m[3] * i,
                a = this.m[0] * -i + this.m[2] * o, n = this.m[1] * -i + this.m[3] * o;
        ...
        if (o || (o = "image/png"), this.mozGetAsFile) t(this.mozGetAsFile("canvas", o)); else if (this.msToBlob && /^\s*image\/png\s*(?:$|;)/i.test(o)) t(this.msToBlob()); else {
            var i, e = Array.prototype.slice.call(arguments, 1), s = this[l].apply(this, e), a = s.indexOf(","),
                n = s.substring(a + 1), h = r.test(s.substring(0, a));
            Blob.fake ? ((i = new Blob).encoding = h ? "base64" : "URI", i.data = n, i.size = n.length) : u && (i = h ? new Blob([function (t) {
                ...
                return s
            }(n)], {type: o}) : new Blob([decodeURIComponent(n)], {type: o})), t(i)
        }
    }), !i.toBlobHD && i.toDataURLHD ? i.toBlobHD = function () {
        l = "toDataURLHD";
        var t = this.toBlob();
        return l = "toDataURL", t
    } : i.toBlobHD = i.toBlob), function (r) {
        ...
        function e(t) {
            var o, i, e = t || p.event, s = [].slice.call(arguments, 1), a = 0, n = 0, h = 0;
        ...
        var t = function () {
            ...
            var e = i.scrollHeight > i.clientHeight, s = /^(visible|auto)$/.test(t) || /^(visible|auto)$/.test(o);
    ...
    a.prototype = {
        _normalizePageIndex: function (t) {
            ...
            if (t < 0) {
                ...
                if (null != this.rightBelowPage && (this.root.pages[this.rightBelowPage].css({
                    ...
                    transform: "",
                    "z-index": 1
                }), this.root._setShowHidePageState(this.rightBelowPage, !0)), null != this.leftBelowPage && this.root.pages[this.leftBelowPage].css({"z-index": 2}), null != this.leftBackPage && this.root.pages[this.leftBackPage].css({"z-index": 3}), null != this.leftPage && this.root.pages[this.leftPage].css({"z-index": 4}), 90 < o ? (null != this.rightPage && (this.root.pages[this.rightPage].css({display: "none"}), this.root._setShowHidePageState(this.rightPage, !1)), null != this.rightBackPage && (this.root.pages[this.rightBackPage].css({
                    display: "block",
                    transform: "rotateY(" + (180 + t) + "deg) translateZ(0px)",
                    "z-index": 7
                }).$shadow.css({opacity: i}), this.root._setShowHidePageState(this.rightBackPage, !0))) : (null != this.rightPage && (this.root.pages[this.rightPage].css({
                    display: "block",
                    transform: "rotateY(" + t + "deg) translateZ(0px)",
                    "z-index": 7
                }).$shadow.css({opacity: i}), this.root._setShowHidePageState(this.rightPage, !0)), null != this.rightBackPage && (this.root.pages[this.rightBackPage].css({display: "none"}), this.root._setShowHidePageState(this.rightBackPage, !1))), null == this.leftPage) {
                    if (90 < o) {
                        var e = 1 - (o - 90) / 90, s = s - this.root.pageWidth * this.root._getZoom() / 2 * e;
                ...
                if (null != this.leftBelowPage && (this.root.pages[this.leftBelowPage].css({
                    ...
                    transform: "",
                    "z-index": 1
                }), this.root._setShowHidePageState(this.leftBelowPage, !0)), null != this.rightBelowPage && this.root.pages[this.rightBelowPage].css({"z-index": 2}), null != this.rightBackPage && this.root.pages[this.rightBackPage].css({"z-index": 3}), null != this.rightPage && this.root.pages[this.rightPage].css({"z-index": 4}), 90 < o ? (null != this.leftPage && (this.root.pages[this.leftPage].css({display: "none"}), this.root._setShowHidePageState(this.leftPage, !1)), null != this.leftBackPage && (this.root.pages[this.leftBackPage].css({
                    display: "block",
                    transform: "rotateY(" + (-180 + t) + "deg) translateZ(0px)",
                    "z-index": 7
                }).$shadow.css({opacity: i}), this.root._setShowHidePageState(this.leftBackPage, !0))) : (null != this.leftPage && (this.root.pages[this.leftPage].css({
                    display: "block",
                    transform: "rotateY(" + t + "deg) translateZ(0px)",
                    "z-index": 7
                }).$shadow.css({opacity: i}), this.root._setShowHidePageState(this.leftPage, !0)), null != this.leftBackPage && (this.root.pages[this.leftBackPage].css({display: "none"}), this.root._setShowHidePageState(this.leftBackPage, !1))), null == this.leftBelowPage) {
                    if (o < 90) {
                        e = 1 - (90 - o) / 90, s = s - this.root.pageWidth * this.root._getZoom() / 2 * e;
                        this.root.controls.$book.css({transform: "translateX(" + s + "px)"})
                    }
            ...
            var t = 0;
            0 == this.rightPage ? t -= this.root.pageWidth * this.root._getZoom() / 2 : this.leftPage == this.root.pages.length - 1 && (t += this.root.pageWidth * this.root._getZoom() / 2), this.root.controls.$book.css({transform: "translateX(" + t + "px)"});
            ...
            var o = this._getLeftPageIndex(t), i = this._getRightPageIndex(t), e = this._getBackPageIndex(o),
                s = this._getBackPageIndex(i), a = this._getBelowPageIndex(o), n = this._getBelowPageIndex(i);
            ...
            this.root.currPage = t, this.leftPage = o, this.rightPage = i, this.leftBackPage = e, this.rightBackPage = s, this.leftBelowPage = a, this.rightBelowPage = n, null != this.leftPage && this.root.pages[this.leftPage].$shadow.css({opacity: 0}), null != this.leftBackPage && this.root.pages[this.leftBackPage].$shadow.css({opacity: 0}), null != this.leftBelowPage && this.root.pages[this.leftBelowPage].$shadow.css({opacity: 0}), null != this.rightPage && this.root.pages[this.rightPage].$shadow.css({opacity: 0}), null != this.rightBackPage && this.root.pages[this.rightBackPage].$shadow.css({opacity: 0}), null != this.rightBelowPage && this.root.pages[this.rightBelowPage].$shadow.css({opacity: 0}), this.updateBookLayout(), this.root._onShowPage(t)
        }, gotoPage: function (t) {
            if (this._stopAnimation(!0), t = this._normalizePageIndex(t), this.leftPage != t && this.rightPage != t) {
                var o = t, i = o < this.root.currPage ? 180 : -180;
        ...
        _normalizePageIndex: function (t) {
            ...
            if (t < 0) {
                ...
                null != this.prevPage && (this.root.pages[this.prevPage].css({display: "none"}), this.root._setShowHidePageState(this.prevPage, !1)), null != this.currPage && (this.root.pages[this.currPage].css({
                    display: "block",
                    transform: "rotateY(" + t + "deg) translateZ(0px)",
                    "z-index": 2
                }).$shadow.css({opacity: 0}), this.root._setShowHidePageState(this.currPage, !0)), null != this.nextPage && (this.root.pages[this.nextPage].css({
                    display: "block",
                    transform: "",
                    "z-index": 1
                ...
                null != this.prevPage && (this.root.pages[this.prevPage].css({
                    ...
                    "z-index": 2
                }).$shadow.css({opacity: 0}), this.root._setShowHidePageState(this.prevPage, !0)), null != this.currPage && (this.root.pages[this.currPage].css({
                    display: "block",
                    transform: "",
                    "z-index": 1
                }), this.root._setShowHidePageState(this.currPage, !0)), null != this.nextPage && (this.root.pages[this.nextPage].css({display: "none"}), this.root._setShowHidePageState(this.nextPage, !1))
            }
        }, _animateTurnPage: function (t, o) {
            var i = d.Deferred();
            this._stopAnimation();
            ...
            pdfAutoCreatePages: !(h.prototype = {
                _normalizePageIndex: function (t) {
                    ...
                    var e = (e = this.root.$container.width() / 2 + this.root.pageWidth * i / 2) / i,
                        s = this.config.pageFade ? Math.abs(t) / 50 : 1, a = this.config.pageFade ? 1 - s : 1;
                    if ((t = e * t / 50) < 0) {
                        if (null == this.nextPage) return;
                        null != this.prevPage && (this.root.pages[this.prevPage].css({display: "none"}), this.root._setShowHidePageState(this.prevPage, !1)), null != this.currPage && (this.root.pages[this.currPage].css({
                            display: "block",
                    ...
                    var o = t = this._normalizePageIndex(t), i = this._getPrevPageIndex(o),
        ...
        _create: function () {
            ...
            function e() {
                ...
                i.controls.$book.css({
                    width: i.bookWidth,
                    height: i.bookHeight
                }), i._initPages(), i._initThumbnails(), i._initBookmarks(), i._setZoom({zoom: i.config.zoom}, !0, !0), i._updateSize(), i._updateBookEngine(), i._ready()
            }
        ...
        _buildToolbarDOM: function () {
            if (this.config.toolbar) {
                ...
                for (var t = [], o = [], i = 0; i < this.config.toolbarControls.length; i++) {
                    var e = this.config.toolbarControls[i], s = d("<i></i>").addClass(e.icon),
        ...
        _initThumbnails: function () {
            if (this.controls.$thumbnails) for (var t = this.pageHeight / this.pageWidth, o = .8 * this.controls.$thumbnails.outerWidth(), i = t * o, e = 0; e < this.pages.length; e++) {
                var s = this.pages[e], a = d("<div></div>").addClass("ipgs-preloader"),
                    n = d("<div></div>").addClass("ipgs-number").text(e + 1), h = d("<div></div>").css({
                        width: o + "px",
                        height: i + "px"
        ...
        _addBookmarks: function (t, o) {
            if (o && 0 < o.length) {
                ...
                for (var e = 0; e < o.length; e++) {
                    var s = o[e], a = d("<div></div>").addClass("ipgs-state"),
                        n = d("<div></div>").addClass("ipgs-link").html(s.text),
                        h = d("<div></div>").addClass("ipgs-bookmark"), r = s.target ? s.target : "page",
                        l = 0 != s.folded;
        ...
        _addPage: function (t) {
            var o = d(t), i = d("<div></div>").addClass("ipgs-preloader"), e = d("<div></div>").addClass("ipgs-image"),
                s = d("<div></div>").addClass("ipgs-data"), a = d("<div></div>").addClass("ipgs-number"),
                n = d("<div></div>").addClass("ipgs-shadow"), h = d("<div></div>").css({
                    display: "none",
        ...
        _updateSize: function () {
            var t = this._getZoom(), o = this.bookWidth, i = this.bookHeight, e = this.stagePadding.top,
                s = this.stagePadding.bottom, a = this.stagePadding.left, n = this.stagePadding.right,
            ...
            l = (u - i * d) / 2, g = (h - o * d) / 2, this.controls.$bookTransform.css({
                ...
                width: o * d + "px",
                height: i * d + "px"
            }), this.controls.$bookWrap.get(0).offsetHeight, this.controls.$bookSize.css({transform: "scale(" + 1 / t * d + ")"}), this._updateThumbnails(), this.engine.updateBookLayout()
        },
        _updateBookEngine: function () {
            var t = this.config.bookEngineLandscape || this.config.bookEngine,
                o = this.config.bookEnginePortrait || this.config.bookEngine, i = this.stagePadding.top,
                e = this.stagePadding.bottom, s = this.stagePadding.left, a = this.stagePadding.right;
        ...
        _updateZoomPosition: function () {
            ...
            this.controls.$bookTransform.css({transform: "translate3d(" + o.x + "px," + o.y + "px, 0) scale(" + t + ")"}), this.controls.$book.addClass("ipgs-no-transition"), this.controls.$book.css({
        ...
        _setDeltaPosition: function (t) {
            var o = t.dx || 0, i = t.dy || 0, e = this.matrix.inverse().transformPoint(o, i),
                s = this.matrix.inverse().transformPoint(0, 0), a = e[0] - s[0], n = e[1] - s[1];
                    ...
                    if (a.image) {
                        ...
                        n.pdf.getPage(a.pdfPage).then(function (t) {
                            var o = t.getViewport(n.pageWidth * n._getZoom() / t.getViewport(1).width),
                                i = d("<canvas>"), e = i.get(0).getContext("2d");
        ...
        _loadThumbData: function (a) {
            if (!a.pageLoaded && !a.pageLoading) {
                ...
                if (a.image) {
                    ...
                    var o = t.getViewport(a.width() / t.getViewport(1).width), i = d("<canvas>"),
        ...
        _onDblTapZoomDefault: function (t) {
            if (this.tapped) clearTimeout(this.tapped), this.tapped = null, this._setZoom({zoom: 1}, !0, !1); else {
                var o = this;
        ...
        _onMouseWheelZoom: function (t, o) {
            ...
            var i, e = this.controls.$stage.get(0).getBoundingClientRect(), s = t.clientX, a = t.clientY,
                n = 1 + .1 * o;
            s -= e.left, a -= e.top, i = {
                x: s - (e.right - e.left) / 2,
                y: a - (e.bottom - e.top) / 2
            }, this._setDeltaZoom({zoom: n, focalPoint: i})
        },
        ...
        _onPinchZoomTouchMove: function (t) {
            if (this.pinchZoom.aIsMoving || this.pinchZoom.bIsMoving) {
                ...
                var o = (new Date).getTime(), i = (this.pinchZoom.startDate, this.pinchZoom.aCurX),
                    e = this.pinchZoom.aCurY, s = this.pinchZoom.bCurX, a = this.pinchZoom.bCurY,
                    n = i - this.pinchZoom.aStartX, h = e - this.pinchZoom.aStartY, r = s - this.pinchZoom.bStartX,
        ...
        _onBookmarkClick: function (t) {
            ...
            if (d(t.target).is(".ipgs-state")) o.toggleClass("ipgs-folded"); else {
        ...
        return this.each(function () {
            var n = d(this), h = n.data(v), t = n.data("json"), r = n.data("pdf-src"),
                l = n.data("pdf-disable-range-requests"), g = n.data("book-engine"),
                p = parseInt(n.data("page-width"), 10), c = parseInt(n.data("page-height"), 10),
            ...
            function o() {
                ...
                if (t.bookEngine = g || t.bookEngine, t.pageWidth = isNaN(p) ? t.pageWidth : p, t.pageHeight = isNaN(c) ? t.pageHeight : c, "boolean" == typeof l && (t.pdfDisableRangeRequests = l), null == t.pdfUrl && r && (t.pdfUrl = r, t.pdfAutoCreatePages = !0, t.pdfBookSizeFromDocument = !0), u.toolbarControls && u.toolbarControls instanceof Array && (t.toolbarControls = o(b.prototype.defaults.toolbarControls, u.toolbarControls)), u.shareControls && u.shareControls instanceof Array && (t.shareControls = o(b.prototype.defaults.shareControls, u.shareControls)), u.bookmarks && u.bookmarks instanceof Array && (t.bookmarks = d.extend(!0, [], u.bookmarks)), null == t.flipSoundUrl) {
                    var i = f.getElementsByTagName("script"), e = "jquery.ipages.min", s = null;
